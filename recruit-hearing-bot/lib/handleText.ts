...
const GAIN_BY_KEY: Record<string, string> = {
  trigger: "きっかけを伺いました。興味の源を一緒に深めていけますね",
  image: "いまのIBM像を伺いました。理解のギャップを一緒に埋めていけます",
  values: "大切にしたいことを伺いました。就活の軸の土台になりますね",
  strengths: "強みを伺いました。IBMで活かせる場面を一緒に考えられます",
  concerns: "引っかかっている点を伺いました。一つずつ整理していきましょう",
  work_style: "力を発揮できる環境を伺いました。実際の働き方と照らせます",
  axis: "いまの軸を言葉にできましたね。ここから一緒に磨いていけます",
};
